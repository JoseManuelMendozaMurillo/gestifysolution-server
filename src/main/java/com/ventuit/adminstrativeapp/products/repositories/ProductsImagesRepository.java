...
public interface ProductsImagesRepository extends BaseRepository<ProductsImagesModel, Integer> {
    ...
    List<ProductsImagesModel> findByProductId(Integer productId);

    List<ProductsImagesModel> findByProductIdAndDeletedAtIsNull(Integer productId);

    List<ProductsImagesModel> findByProductIdAndDeletedAtIsNotNull(Integer productId);
